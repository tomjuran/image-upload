...
const defaultImageSrc = '/public/img/plant.jfif'
    ...
    return (
        ...
        <form autoComplete="off" noValidate onSubmit={handleFormSubmit} >
            ...
            <div className="card-body">
                ...
                <div className="form-group">
                    <input className={"form-control-file"+applyErrorClass('employeeName')} placeholder="Employee Name" name="employeeName" value={values.employeeName} onChange = {handleInputChange} />
                </div>
                <div className="form-group">
